      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form id="frm-generol" class="form-horizontal"  action="?c=escalar&a=Guardar" method="post" enctype="multipart/form-data">
              <div class="box-body">
                        ...
                        <div class="form-group">
                              ...
                              <input type="hidden" name="TRIN_Id" id="TRIN_Id" value="<?php echo $incidencia->TRIN_Id; ?> ">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="USUA_Id" class="col-sm-3 control-label">Responsable</label>
                            <div class="col-sm-6">
                                <select class="form-control " name="USUA_Id"  id="USUA_Id">
                                     <?php foreach($this->model->SelectTrabajadores() as $r): ?>
