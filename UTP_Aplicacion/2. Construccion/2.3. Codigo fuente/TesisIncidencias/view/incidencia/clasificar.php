  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Incidencias registradas</a></li>
        <li><a href="#">Maestros</a></li>
        <li class="active">Clasificar incidencias</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
            <div class="box-header with-border">
               <h3 class="box-title">Clasificar incidencias</h3>
                ...
                <tbody>
                  <?php foreach($this->model->ListaIncidenciasRegistradas() as $r): ?>
                    <tr>
                      ...
                      <td> <a href="?c=clasificar&a=Crud&Id=<?php echo $r->INCI_Id; ?>" data-toggle="tooltip" title="Editar" class="btn btn-social-icon btn-info btn-sm" ><i class="fa fa-fw fa-edit" ></i></a>  </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
            </table> 
