  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Lista de incidencias </a></li>
        <li><a href="#">Maestros</a></li>
        <li class="active">Cierre incidencias</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <table   id="tbDTb" class="table table-striped  table-bordered">
                ...
                <tbody>
                  <?php foreach($this->model->ListaIncidenciasParaCierre() as $r): ?>
                    <tr id="<?php echo $r->INCI_Id; ?>">
                      ...
                      <td> <a                                
                              ...
                              data-href="
                                ?c=cierre&a=Guardar&
                                INCI_Id=<?php echo $r->INCI_Id; ?>&
                                TRIN_Id=<?php echo $r->TRIN_Id; ?>"  
                              data-toggle="modal" 
