          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <div class="col-md-2">
                    <a class="btn btn-primary btn-sm pull-right" rel="tooltip" title="Vista Previa" onclick="ReporteIncidenciaPorCategoria()">Vista Previa<i class="fa fa-fw fa-info-circle"></i></a> 
                  </div>
                    ...
                    <div class="col-md-12">                         
                              <div class="form-group">
                                        <div class="box-body table-responsive no-padding">
                                                   <table id="TablaReporteIncidenciasCategoria"  class="table table-hover">
                                                      <thead>
                                                          <tr>
                                                              <th>Codigo</th>
                                                              <th>Titulo</th>
