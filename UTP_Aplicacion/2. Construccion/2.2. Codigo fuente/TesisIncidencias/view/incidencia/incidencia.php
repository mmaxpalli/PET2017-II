                ...
                <tbody>
                  <?php foreach($this->model->ListaIncidenciasRegistradas() as $r): ?>
                    <tr>
                      ...
                      <td> <a href="?c=incidencia&a=Crud&Id=<?php echo $r->INCI_Id; ?>" data-toggle="tooltip" title="Editar" class="btn btn-social-icon btn-danger btn-sm" ><i class="fa fa-fw fa-pencil " ></i></a>  </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
            </table> 
