  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="?c=clasificar">Lista incidencias</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form id="frm-generol" class="form-horizontal"  action="?c=clasificar&a=ClasificarIncidencia" method="post" enctype="multipart/form-data">
              <div class="box-body">
