                ...
                <tbody>
                  <?php foreach($this->model->ListaIncidenciasProcesando() as $r): ?>
                    <tr>
                      ...
                      <td> <a href="?c=escalar&a=Crud&Id=<?php echo $r->INCI_Id; ?>" data-toggle="tooltip" title="Editar" class="btn btn-social-icon btn-info btn-sm" ><i class="fa fa-fw fa-edit" ></i></a>  </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
            </table> 
